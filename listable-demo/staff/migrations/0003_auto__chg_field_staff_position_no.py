...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Staff.position_no'
        db.alter_column(u'staff_staff', 'position_no', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Staff.position_no'
        raise RuntimeError("Cannot reverse this migration. 'Staff.position_no' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Staff.position_no'
        db.alter_column(u'staff_staff', 'position_no', self.gf('django.db.models.fields.CharField')(max_length=255))
